  ...
  return (
    <SafeAreaView style={{}}>
      ...
      <View style={{justifyContent: 'space-between', flexDirection: 'row'}}>
        <TouchableOpacity
          style={{borderRadius: 5, backgroundColor: '#00425A', margin: 10}}
          onPress={() => {
            setModalVisible(true);
          }}>
      ...
      <ScrollView contentInsetAdjustmentBehavior="automatic" style={{}}>
        ...
        <View style={{padding: 20}}>
          ...
          <TouchableOpacity
            ...
            <Text style={{fontWeight: '900', marginTop: 10}}>Change Date</Text>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                if (productName.length > 0) {
                  if (editPosition != -1) {
                    productList[editPosition].name = productName;
                    setEditPosition(-1);
                  } else {
                    productList.push({
                      name: productName,
